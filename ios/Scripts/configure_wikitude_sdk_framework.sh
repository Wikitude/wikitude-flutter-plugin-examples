...
#
#  Created by Damian Bermejo on 11/12/19.
#
#
...
# Once the Wikitude Flutter plugin is installing, these files are combined again into a single file.
...
# Find all occurences of the WikitudeSDK.framework in the Flutter application directory structure (The current working directory is the iOS workspace directory)
find ../plugin/augmented_reality_plugin_wikitude/ios/ -type d -name "WikitudeSDK.framework" | while read dir; do
